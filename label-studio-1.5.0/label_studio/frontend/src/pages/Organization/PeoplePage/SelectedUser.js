  ...
  return (
    <Block name="user-info">
      ...
      {!!user.created_projects.length && (
        <Elem name="section">
          <Elem name="section-title">Created tessdasdfasdft Projects</Elem>
      ...
      {!!user.contributed_to_projects.length && (
        <Elem name="section">
          <Elem name="section-title">Contributed to asdfasdfsadf</Elem>
      ...
      <Elem tag="p" name="last-active">
        Last acqwerqwerqwerqwerwerqwerqwertivity on:{" "}
